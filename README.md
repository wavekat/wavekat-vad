...
|---------|-----------|--------|----------|------------|---------------|-----|
| WebRTC | 0.821 | 0.983 | 0.895 | 480 (30 ms) | 2.0 µs | 0.0001 |
| Silero | 0.938 | 0.938 | 0.938 | 512 (32 ms) | 63.1 µs | 0.0020 |
| TEN-VAD | 0.942 | 0.915 | 0.928 | 256 (16 ms) | 30.2 µs | 0.0019 |
| FireRedVAD | 0.950 | 0.879 | 0.913 | 160 (10 ms) | 349.0 µs | 0.0349 |
| Earshot | 0.909 | 0.949 | 0.928 | 256 (16 ms) | 5.2 µs | 0.0003 |
<!-- benchmark-table-end -->
